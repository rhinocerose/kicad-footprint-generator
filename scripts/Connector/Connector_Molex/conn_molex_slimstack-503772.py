...
http://www.molex.com/pdm_docs/sd/5037722420_sd.pdf
...
part_code = "503772-{pn:s}"

pitch = 0.4

def generate_one_footprint(partnumber, configuration):
    pincount = int(partnumber[:2])
    datasheet = "http://www.molex.com/pdm_docs/sd/5037722420_sd.pdf"
    ...
    anchor_height = 0.47
    center_height = 0.44
    anchor_x_offset = 0.75  # between pad centers
    anchor_y_space = 1.82  # free space between anchors
    swapped = False  # Even pads on top?
