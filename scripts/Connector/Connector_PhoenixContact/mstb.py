...
def generate_one_footprint(model, params, configuration):
    ...
    #################################################### 3d file ###################################################
    p3dname = '{prefix:s}{lib_name:s}.3dshapes/{fp_name}.wrl'.format(prefix = configuration.get('3d_model_prefix', '${KICAD7_3DMODEL_DIR}/'), lib_name=lib_name, fp_name=footprint_name)
