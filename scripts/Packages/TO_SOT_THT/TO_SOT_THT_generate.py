...
if __name__ == '__main__':
    ...
    #makeVERTLS("${KICAD7_3DMODEL_DIR}/Package_TO_SOT_THT", pack("SOT93", 2, 0, 0, False),False, [0, 0, 0], [0, 0, 0])
    #exit()
    ...
    for p in range(0, len(packs)):
        for pidx in range(0, len(pins[p])):
            ...
            #makeVERT("${KICAD7_3DMODEL_DIR}/Package_TO_SOT_THT", pack_largepins, True, o3d, s3d)
            #makeHOR("${KICAD7_3DMODEL_DIR}/Package_TO_SOT_THT", pack_largepins, True, o3d, s3d)
            #if (len(pack_largepins.additional_pin_pad) <= 0):
            #    makeHORREV("${KICAD7_3DMODEL_DIR}/Package_TO_SOT_THT", pack_largepins, True, o3d, s3d)
