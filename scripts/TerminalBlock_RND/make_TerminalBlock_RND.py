...
if __name__ == '__main__':
    ...
    for p in pins:
        makeTerminalBlockVertical(footprint_name="TerminalBlock_RND_205-{0:05}_1x{2:02}_P{1:3.2f}mm_Vertical".format(274+p, rm, p), 
                                  ...
                                  tags_additional=[], lib_name="${KICAD7_3DMODEL_DIR}/TerminalBlock_RND", classname="TerminalBlock_RND", classname_description="terminal block RND 205-{0:05}".format(76+p), webpage="http://cdn-reichelt.de/documents/datenblatt/C151/RND_205-00276_DB_EN.pdf", script_generated_note=script_generated_note)
    ...
    for p in pins:
        ...
        makeTerminalBlockStd(footprint_name=footprint_name, 
                                  ...
                                  nibbleSize=nibbleSize, nibblePos=nibblePos, fabref_offset=fabref_offset,
                                  tags_additional=[], lib_name='${KICAD7_3DMODEL_DIR}/'+classname, classname=classname, classname_description=classname_description, 
    ...
    for p in pins:
        ...
        makeTerminalBlock45Degree(footprint_name=footprint_name, 
                                  ...
                                  nibbleSize=nibbleSize, nibblePos=nibblePos, fabref_offset=fabref_offset,
                                  tags_additional=[], lib_name="${KICAD7_3DMODEL_DIR}/"+classname, classname=classname, classname_description=classname_description, webpage=webpage, script_generated_note=script_generated_note)
